 ...
 * @param count Optional: amount of events to wait for (default 1).
 ...
 * @param context Optional: CoroutineContext in which to run the KPromise that this returns (defaults to ForkJoinPool.commonPool()).
 * @param check Optional: predicate to check received events against. If this function returns true when passed the event, the event is added to the result to be returned (default none, all events are returned).
 *
